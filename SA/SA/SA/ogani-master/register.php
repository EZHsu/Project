                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="dblinkback.php" method="post">
                                ...
                                <div class="form-group">
                                    <input type="email" class="form-control form-control-user" name = "account" value="<?php echo $account?>"
                                        placeholder="手機號碼" required>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                        <input type="password" class="form-control form-control-user"
                                            name = "password" value="<?php echo $password?>" placeholder="密碼" required>
                                    </div>
<!--
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control form-control-user"
...
-->
                                     ...
                                     <input type = "submit" value="註冊" class="btn btn-primary btn-user btn-block"> 
